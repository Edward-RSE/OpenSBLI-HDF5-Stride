...
void HDF5_IO_Write_0_opensbliblock00(ops_block &opensbliblock00, ops_dat &rho_B0, ops_dat &rhou0_B0, ops_dat &rhou1_B0,
                                     ops_dat &rhoE_B0, ops_dat &x0_B0, ops_dat &x1_B0, int HDF5_timing) {
  double cpu_start0, elapsed_start0;
  if (HDF5_timing == 1) {
    ops_timers(&cpu_start0, &elapsed_start0);
  }
...
void HDF5_IO_Write_Strided_0_opensbliblock00(ops_block &opensbliblock00, ops_dat &rho_B0, ops_dat &rhou0_B0,
  ...
  ops_dat rho_B0_strided = create_strided_ops_dat_with_halo_cells(rho_B0, stride_i, stride_j);
  ops_dat rhou0_B0_strided = create_strided_ops_dat_with_halo_cells(rhou0_B0, stride_i, stride_j);
  ops_dat rhou1_B0_strided = create_strided_ops_dat_with_halo_cells(rhou1_B0, stride_i, stride_j);
  ops_dat rhoE_B0_strided = create_strided_ops_dat_with_halo_cells(rhoE_B0, stride_i, stride_j);
  ops_dat x0_B0_strided = create_strided_ops_dat_with_halo_cells(x0_B0, stride_i, stride_j);
  ops_dat x1_B0_strided = create_strided_ops_dat_with_halo_cells(x1_B0, stride_i, stride_j);
  ...
  ops_fetch_dat_hdf5_file(x0_B0_strided, name0);
  ops_fetch_dat_hdf5_file(x1_B0_strided, name0);
