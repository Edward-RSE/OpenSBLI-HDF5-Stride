 ...
 *
 */
void copy_to_strided_dat(ops_block block, int block0np0, int block0np1, int stride[], ops_dat &original_dat,
                         ops_dat &strided_dat) {
...
void HDF5_IO_Write_0_opensbliblock00_strided(ops_block block, int block0np0, int block0np1, int stride[],
  ...
  copy_to_strided_dat(block, block0np0, block0np1, stride, rho_B0, rho_B0_strided);
