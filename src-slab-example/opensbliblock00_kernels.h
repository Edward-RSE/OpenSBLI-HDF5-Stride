...
&rhou2_RKold_B0)
{
   ...
   double rj3 = 0.0;
   double rj4 = 0.0;
    if (fmax(kappa_B0(0,0,-2), fmax(kappa_B0(0,0,-3), fmax(kappa_B0(0,0,1), fmax(kappa_B0(0,0,-1), fmax(kappa_B0(0,0,2),
      kappa_B0(0,0,0)))))) > Ducros_check){
...
: (
   1
    ...
    WENO_filter_B0(0,0,0) = ((fmax(kappa_B0(2,0,0), fmax(kappa_B0(0,2,0), fmax(kappa_B0(-1,0,0), fmax(kappa_B0(0,-1,0),
      fmax(kappa_B0(0,0,-1), fmax(kappa_B0(0,0,0), fmax(kappa_B0(1,0,0), fmax(kappa_B0(0,1,0), fmax(kappa_B0(0,0,1),
