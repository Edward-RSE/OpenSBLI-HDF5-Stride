...
#include "bc_exchanges.h"
  ...
  if (restart == 0) {
    ...
    ops_par_loop(opensbliblock00Kernel041, "Grid_based_initialisation0", opensbliblock00, 3, iteration_range_41_block0,
                 ...
                 ops_arg_dat(x2_B0, 1, stencil_0_00_00_00_3, "double", OPS_RW), ops_arg_idx());
  }
  ...
  ops_par_loop(opensbliblock00Kernel043, "MetricsEquation evaluation", opensbliblock00, 3, iteration_range_43_block0,
               ...
               ops_arg_dat(wk4_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE), ops_arg_idx());
  ...
  ops_par_loop(opensbliblock00Kernel046, "Metric_copy_block0 boundary dir1 side0", opensbliblock00, 3,
               iteration_range_46_block0, ops_arg_dat(D11_B0, 1, stencil_0_00_55_00_20, "double", OPS_RW),
  ...
  ops_par_loop(opensbliblock00Kernel047, "Metric_copy_block0 boundary dir1 side1", opensbliblock00, 3,
               iteration_range_47_block0, ops_arg_dat(D11_B0, 1, stencil_0_00_55_00_20, "double", OPS_RW),
               ops_arg_dat(detJ_B0, 1, stencil_0_00_55_00_20, "double", OPS_RW));
  ...
  ops_par_loop(opensbliblock00Kernel051, "MetricsEquation evaluation", opensbliblock00, 3, iteration_range_51_block0,
               ...
               ops_arg_dat(SD111_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE), ops_arg_idx());
  ...
  for (iter = start_iter; iter <= start_iter + niter - 1; iter++) {
    ...
    ops_par_loop(opensbliblock00Kernel037, "IsothermalWall boundary dir1 side0", opensbliblock00, 3,
                 iteration_range_37_block0, ops_arg_dat(rhoE_B0, 1, stencil_0_00_51_00_15, "double", OPS_RW),
    ...
    ops_par_loop(opensbliblock00Kernel038, "IsothermalWall boundary dir1 side1", opensbliblock00, 3,
                 iteration_range_38_block0, ops_arg_dat(rhoE_B0, 1, stencil_0_00_15_00_15, "double", OPS_RW),
                 ops_arg_dat(rho_B0, 1, stencil_0_00_55_00_23, "double", OPS_RW),
                 ops_arg_dat(rhou0_B0, 1, stencil_0_00_55_00_23, "double", OPS_RW),
                 ops_arg_dat(rhou1_B0, 1, stencil_0_00_55_00_23, "double", OPS_RW),
                 ops_arg_dat(rhou2_B0, 1, stencil_0_00_55_00_23, "double", OPS_RW));
    ...
    for (stage = 0; stage <= 4; stage++) {
      ...
      ops_par_loop(opensbliblock00Kernel004, "Derivative evaluation CD u0_B0 xi0 ", opensbliblock00, 3,
                   iteration_range_4_block0, ops_arg_dat(u0_B0, 1, stencil_0_22_00_00_8, "double", OPS_READ),
      ...
      ops_par_loop(opensbliblock00Kernel006, "Derivative evaluation CD u1_B0 xi0 ", opensbliblock00, 3,
                   iteration_range_6_block0, ops_arg_dat(u1_B0, 1, stencil_0_22_00_00_8, "double", OPS_READ),
      ...
      ops_par_loop(opensbliblock00Kernel008, "Derivative evaluation CD u2_B0 xi0 ", opensbliblock00, 3,
                   iteration_range_8_block0, ops_arg_dat(u2_B0, 1, stencil_0_22_00_00_8, "double", OPS_READ),
      ...
      ops_par_loop(opensbliblock00Kernel010, "Derivative evaluation CD T_B0 xi0 ", opensbliblock00, 3,
                   iteration_range_10_block0, ops_arg_dat(T_B0, 1, stencil_0_22_00_00_8, "double", OPS_READ),
      ...
      ops_par_loop(opensbliblock00Kernel012, "Derivative evaluation CD u0_B0 xi1 ", opensbliblock00, 3,
                   iteration_range_12_block0, ops_arg_dat(u0_B0, 1, stencil_0_00_44_00_19, "double", OPS_READ),
                   ops_arg_dat(wk4_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE), ops_arg_idx());

      int iteration_range_13_block0[] = {0, block0np0, 0, block0np1, -2, block0np2 + 2};
      ops_par_loop(opensbliblock00Kernel013, "Derivative evaluation CD u1_B0 xi1 ", opensbliblock00, 3,
                   iteration_range_13_block0, ops_arg_dat(u1_B0, 1, stencil_0_00_44_00_19, "double", OPS_READ),
                   ops_arg_dat(wk5_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE), ops_arg_idx());

      int iteration_range_14_block0[] = {0, block0np0, 0, block0np1, -2, block0np2 + 2};
      ops_par_loop(opensbliblock00Kernel014, "Derivative evaluation CD u2_B0 xi1 ", opensbliblock00, 3,
                   iteration_range_14_block0, ops_arg_dat(u2_B0, 1, stencil_0_00_44_00_19, "double", OPS_READ),
                   ops_arg_dat(wk6_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE), ops_arg_idx());

      int iteration_range_15_block0[] = {0, block0np0, 0, block0np1, 0, block0np2};
      ops_par_loop(opensbliblock00Kernel015, "Derivative evaluation CD T_B0 xi1 ", opensbliblock00, 3,
                   iteration_range_15_block0, ops_arg_dat(T_B0, 1, stencil_0_00_44_00_19, "double", OPS_READ),
                   ops_arg_dat(wk7_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE), ops_arg_idx());

      int iteration_range_16_block0[] = {0, block0np0, 0, block0np1, 0, block0np2};
      ops_par_loop(opensbliblock00Kernel016, "Derivative evaluation CD u0_B0 xi2 ", opensbliblock00, 3,
      ...
      ops_par_loop(opensbliblock00Kernel017, "Derivative evaluation CD u1_B0 xi2 ", opensbliblock00, 3,
      ...
      ops_par_loop(opensbliblock00Kernel018, "Derivative evaluation CD u2_B0 xi2 ", opensbliblock00, 3,
      ...
      ops_par_loop(opensbliblock00Kernel019, "Derivative evaluation CD T_B0 xi2 ", opensbliblock00, 3,
                   iteration_range_19_block0, ops_arg_dat(T_B0, 1, stencil_0_00_00_22_8, "double", OPS_READ),
      ...
      ops_par_loop(opensbliblock00Kernel032, "Convective terms", opensbliblock00, 3, iteration_range_32_block0,
                   ...
                   ops_arg_dat(Residual4_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE), ops_arg_idx());
      ...
      ops_par_loop(opensbliblock00Kernel033, "Viscous terms", opensbliblock00, 3, iteration_range_33_block0,
                   ...
                   ops_arg_dat(Residual4_B0, 1, stencil_0_00_00_00_3, "double", OPS_RW), ops_arg_idx());

      int iteration_range_71_block0[] = {0, block0np0, 0, block0np1, 0, block0np2};
      ops_par_loop(opensbliblock00Kernel071, "Temporal solution advancement", opensbliblock00, 3,
                   iteration_range_71_block0, ops_arg_dat(Residual0_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
    ...
    if (fmod(1 + iter, filter_frequency) == 0) {
      ...
      ops_par_loop(opensbliblock00Kernel062, "User kernel: Block 0: Zero the filter array", opensbliblock00, 3,
                   iteration_range_62_block0, ops_arg_dat(rhoE_RKold_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
    ...
    if (fmod(1 + iter, filter_frequency) == 0) {
      ...
      ops_par_loop(opensbliblock00Kernel063, "User kernel: Block 0: DRP filter calculation direction x",
                   opensbliblock00, 3, iteration_range_63_block0,
    ...
    if (fmod(1 + iter, filter_frequency) == 0) {
      ...
      ops_par_loop(opensbliblock00Kernel064, "User kernel: Block 0: DRP filter update direction x", opensbliblock00, 3,
                   iteration_range_64_block0, ops_arg_dat(rhoE_RKold_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
    ...
    if (fmod(1 + iter, filter_frequency) == 0) {
      ...
      ops_par_loop(opensbliblock00Kernel065, "User kernel: Block 0: DRP filter calculation direction y",
                   opensbliblock00, 3, iteration_range_65_block0,
                   ...
                   ops_arg_dat(rhou0_RKold_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
                   ops_arg_dat(rhou1_RKold_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
                   ops_arg_dat(rhou2_RKold_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE), ops_arg_idx());
    }

    if (fmod(1 + iter, filter_frequency) == 0) {
      int iteration_range_66_block0[] = {0, block0np0, 0, block0np1, 0, block0np2};
      ops_par_loop(opensbliblock00Kernel066, "User kernel: Block 0: DRP filter update direction y", opensbliblock00, 3,
                   iteration_range_66_block0, ops_arg_dat(rhoE_RKold_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
                   ops_arg_dat(rho_RKold_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
                   ops_arg_dat(rhou0_RKold_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
                   ops_arg_dat(rhou1_RKold_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
                   ops_arg_dat(rhou2_RKold_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
    ...
    if (fmod(1 + iter, filter_frequency) == 0) {
      ...
      ops_par_loop(opensbliblock00Kernel067, "User kernel: Block 0: DRP filter calculation direction z",
                   opensbliblock00, 3, iteration_range_67_block0,
    ...
    if (fmod(1 + iter, filter_frequency) == 0) {
      ...
      ops_par_loop(opensbliblock00Kernel068, "User kernel: Block 0: DRP filter update direction z", opensbliblock00, 3,
                   iteration_range_68_block0, ops_arg_dat(rhoE_RKold_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
                   ops_arg_dat(rho_RKold_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
                   ops_arg_dat(rhou0_RKold_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
                   ops_arg_dat(rhou1_RKold_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
                   ops_arg_dat(rhou2_RKold_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
    ...
    ops_par_loop(opensbliblock00Kernel052, "User kernel: Constituent Relations evaluation", opensbliblock00, 3,
                 iteration_range_52_block0, ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
                 ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
                 ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
                 ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
                 ops_arg_dat(rhou2_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
    ...
    ops_par_loop(opensbliblock00Kernel056, "UserDefinedEquations evaluation", opensbliblock00, 3,
                 iteration_range_56_block0, ops_arg_dat(D11_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
                 ops_arg_dat(u0_B0, 1, stencil_0_22_44_22_35, "double", OPS_READ),
                 ops_arg_dat(u1_B0, 1, stencil_0_22_44_22_35, "double", OPS_READ),
                 ops_arg_dat(u2_B0, 1, stencil_0_22_44_22_35, "double", OPS_READ),
                 ops_arg_dat(kappa_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE), ops_arg_idx());

    int iteration_range_57_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5, -5, block0np2 + 5};
    ops_par_loop(opensbliblock00Kernel057, "User kernel: Zero the work arrays", opensbliblock00, 3,
                 iteration_range_57_block0, ops_arg_dat(Residual0_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
                 ops_arg_dat(Residual1_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
                 ops_arg_dat(Residual2_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
                 ops_arg_dat(Residual3_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
    ...
    ops_par_loop(opensbliblock00Kernel058, "User kernel: WENO reconstruction direction 0", opensbliblock00, 3,
                 iteration_range_58_block0, ops_arg_dat(a_B0, 1, stencil_0_01_00_00_5, "double", OPS_READ),
    ...
    ops_par_loop(opensbliblock00Kernel059, "User kernel: WENO reconstruction direction 1", opensbliblock00, 3,
                 iteration_range_59_block0, ops_arg_dat(a_B0, 1, stencil_0_00_01_00_5, "double", OPS_READ),
    ...
    ops_par_loop(opensbliblock00Kernel060, "User kernel: WENO reconstruction direction 2", opensbliblock00, 3,
                 iteration_range_60_block0, ops_arg_dat(a_B0, 1, stencil_0_00_00_01_5, "double", OPS_READ),
    ...
    ops_par_loop(opensbliblock00Kernel061, "User kernel: Non-linear filter application", opensbliblock00, 3,
                 iteration_range_61_block0, ops_arg_dat(D11_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
    ...
    if (fmod(1 + iter, write_slices) == 0) {
      ...
      ops_printf("-----------------------------------------\n");
      ops_printf("Time to write slice HDF5 file: %lf\n", elapsed_end0 - elapsed_start0);
      ops_printf("-----------------------------------------\n");
    }
    ...
    if (fmod(1 + iter, write_slices) == 0) {
      char slice_name0[80];
      sprintf(slice_name0, "%d", iter + 1);
      ops_write_plane_group_hdf5({{1, 20}}, slice_name0,
                                 {{rho_B0, rhou0_B0, rhou1_B0, rhou2_B0, rhoE_B0, WENO_filter_B0}});
      ops_write_plane_group_hdf5({{1, block0np1 - 20}}, slice_name0,
                                 {{rho_B0, rhou0_B0, rhou1_B0, rhou2_B0, rhoE_B0, WENO_filter_B0}});
    }
  }
  ops_timers(&cpu_end0, &elapsed_end0);
