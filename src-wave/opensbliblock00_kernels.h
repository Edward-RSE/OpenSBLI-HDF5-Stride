...
void opensbliblock00Kernel007(const ACC<double> &phi_B0, ACC<double> &phi_RKold_B0)
{
   phi_RKold_B0(0) = phi_B0(0);

}

void opensbliblock00Kernel003(const ACC<double> &phi_B0, ACC<double> &wk0_B0)
{
    wk0_B0(0) = (-(2.0/3.0)*phi_B0(-1) - (1.0/12.0)*phi_B0(2) + ((1.0/12.0))*phi_B0(-2) +
      ((2.0/3.0))*phi_B0(1))*invDelta0block0;
