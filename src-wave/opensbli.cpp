...
#include "bc_exchanges.h"
  ...
  if (restart == 0) {
    ...
    ops_par_loop(opensbliblock00Kernel000, "Grid_based_initialisation0", opensbliblock00, 1, iteration_range_0_block0,
                 ...
                 ops_arg_dat(x0_B0, 1, stencil_0_00_1, "double", OPS_RW), ops_arg_idx());
  }
  ...
  for (iter = start_iter; iter <= start_iter + niter - 1; iter++) {
    ...
    for (stage = 0; stage <= 2; stage++) {
      ...
      ops_par_loop(opensbliblock00Kernel008, "Temporal solution advancement", opensbliblock00, 1,
                   iteration_range_8_block0, ops_arg_dat(Residual0_B0, 1, stencil_0_00_1, "double", OPS_READ),
  ...
  HDF5_IO_Write_Strided_0_opensbliblock00(opensbliblock00, phi_B0, x0_B0, 10, HDF5_timing);
